...
Product Backlog, ürünün geliştirme sürecinde gerçekleştirilecek tüm kullanıcı hikâyelerini, önceliklendirilmiş görevleri ve sprint planlamalarını içerecek şekilde hazırlanmıştır. Backlog, kullanıcıya değer katacak temel özellikler önceliklendirilerek üç sprint boyunca geliştirilecek şekilde planlanmıştır. Ürüne ait kullanıcı hikâyeleri, kabul kriterleri, önceliklendirme ve sprint planlamasını içeren Product Backlog aşağıdaki bağlantılarda yer almaktadır.

Not: Proje yönetim sürecinde Jira kullanılmıştır. Son aşamada, Atlassian'ın erişim izinleri nedeniyle paylaşılan Jira bağlantılarının dış kullanıcılar tarafından görüntülenemeyebileceği fark edilmiştir. Bu nedenle değerlendirme sırasında herhangi bir erişim sorunu yaşanmaması adına Product Backlog'un PDF sürümü ile Sprint Board ekran görüntüleri bu repository içerisinde paylaşılmıştır.

[🔗 **Miro Product Backlog**](https://miro.com/app/board/uXjVH9mYBys=/?share_link_id=446281530387)
...
Sprint 1 kapsamında geliştirilen kullanıcı hikâyeleri ve teknik görevler sprint backlog'una alınmış, görevler sprint süresince takip edilerek başarıyla tamamlanmıştır. Her kullanıcı hikâyesi, ekip üyeleri arasında paylaştırılan alt görevlere (subtask) ayrılarak geliştirilmiştir.
...
<p align="center">
  <img src="docs/sprint1/sprint-board/sprint-board-05.jpeg" width="900">
</p>
---
...
- Proje yönetim platformunun dış paylaşıma uygunluğu değerlendirilmiş olup, sonraki sprintlerde Product Backlog ve sprint dokümantasyonunun herkes tarafından erişilebilecek platformlar üzerinden paylaşılması planlanmaktadır.
...
Sprint 2 kapsamında uygulamanın kullanıcı deneyimi ve yapay zekâ destekli koçluk özellikleri geliştirilmiştir. Kullanıcıların uygulamaya girişte karşılandığı açılış (Landing) sayfası oluşturulmuş, ruh hali kaydı, başarısızlık analizi, kişiselleştirilmiş koçluk önerileri ve RAG tabanlı bilimsel strateji öneri sistemi geliştirilmiştir. Böylece Habit Identity Coach, yalnızca alışkanlık takibi yapan bir uygulama olmaktan çıkarılarak kullanıcıya aktif rehberlik sağlayan yapay zekâ destekli bir dijital koç haline getirilmiştir.
...
Sprint 2 backlog'u oluşturulurken uygulamanın yapay zekâ destekli koçluk altyapısını tamamlayacak kullanıcı hikâyelerine öncelik verilmiştir. Kullanıcının uygulamayı tanıyabileceği bir açılış sayfasının geliştirilmesi, ruh hali kayıtlarının tutulması, başarısızlık nedenlerinin analiz edilmesi, kişiselleştirilmiş önerilerin sunulması ve davranış bilimi temelli stratejilere erişebilmesi hedeflenmiştir. Bu doğrultuda toplam **32 Story Point**'lik geliştirme planlanmış ve sprint sonunda başarıyla tamamlanmıştır.

---

## Sprint Backlog

Sprint 2 kapsamında geliştirilen kullanıcı hikâyeleri ve teknik görevler sprint backlog'una alınmış, görevler sprint süresince takip edilerek başarıyla tamamlanmıştır. Her kullanıcı hikâyesi ekip üyeleri arasında paylaştırılan alt görevlere ayrılarak geliştirilmiştir.
...
Sprint süresince görevlerin ilerleyişi Sprint Board üzerinden takip edilmiş ve görev durumları düzenli olarak güncellenmiştir.

📷 **Sprint Board ekran görüntüleri aşağıda yer almaktadır.**

<p align="center">
  <img src="docs/sprint2/sprint-board/sprint-board-01.png" width="900">
</p>

<p align="center">
  <img src="docs/sprint2/sprint-board/sprint-board-02.png" width="900">
</p>

<p align="center">
  <img src="docs/sprint2/sprint-board/sprint-board-03.png" width="900">
</p>

<p align="center">
  <img src="docs/sprint2/sprint-board/sprint-board-04.png" width="900">
</p>

<p align="center">
  <img src="docs/sprint2/sprint-board/sprint-board-05.png" width="900">
</p>
...
Sprint sonunda uygulamaya aşağıdaki modüller eklenmiştir.

- Açılış (Landing) Sayfası
- Ruh Hali Kaydı
- Başarısızlık Analizi
- Kişiselleştirilmiş Koçluk
- Bilimsel Strateji Bilgi Havuzu (RAG)
- Bilimsel Strateji Önerme

📷 **Sprint sonunda geliştirilen ekranlara ait görseller aşağıda yer almaktadır.**

| Anasayfa | Anasayfa |
|----------|-----------|
| <img src="docs/sprint2/product/product-01.png" width="420"> | <img src="docs/sprint2/product/product-02.png" width="420"> |

| Anasayfa | Ruh Hali Kaydı |
|--------------------|-----------------|
| <img src="docs/sprint2/product/product-03.png" width="420"> | <img src="docs/sprint2/product/product-04.png" width="420"> |

| AI Önerisi |
|-----------|
<p align="center">
  <img src="docs/sprint2/product/product-05.png" width="300">
</p>
...
Sprint 2 hedefleri başarıyla tamamlanmıştır. Açılış (Landing) sayfası geliştirilerek uygulamanın ilk kullanıcı deneyimi iyileştirilmiş, yapay zekâ destekli koçluk altyapısı oluşturulmuş ve kullanıcıların başarısızlık nedenlerini analiz ederek kişiselleştirilmiş öneriler sunan sistem uygulamaya entegre edilmiştir. Ayrıca davranış bilimi temelli bilgi havuzu hazırlanmış ve RAG destekli öneri mekanizması başarıyla geliştirilmiştir. Sprint sonunda gerçekleştirilen değerlendirme toplantısında Sprint 3 kapsamında geliştirilecek dashboard, istatistik ve raporlama modülleri için planlama yapılmıştır.
...
- Sprint kapsamında planlanan kullanıcı hikâyeleri başarıyla tamamlandı.
- Açılış (Landing) sayfası geliştirilerek uygulamanın kullanıcı deneyimi iyileştirildi.
- Yapay zekâ destekli koçluk ve RAG altyapısı başarıyla sisteme entegre edildi.
- Düzenli ekip iletişimi sayesinde teknik problemler kısa sürede çözüldü.

### 🔄 Geliştirilebilecek Noktalar

- Yapay zekâ çıktılarının kalitesini artırmak amacıyla prompt yapıları Sprint 3'te optimize edilecektir.
- Dashboard ve raporlama modüllerinin kullanıcı deneyimini destekleyecek şekilde geliştirilmesi hedeflenmektedir.
- Performans optimizasyonları ve sistem testleri Sprint 3 kapsamında tamamlanacaktır.
...
git clone https://github.com/ahmetenes03/identity-coach
